...
##FOR ARCH USERS: get the AUR python-boltons, et voila!
...
XDG_RUNTIME_DIR: Final = os.getenv("XDG_RUNTIME_DIR")
HYPRLAND_SOCKET: Final = f"{XDG_RUNTIME_DIR}/hypr/{HYPRLAND_INSTANCE_SIGNATURE}/.socket2.sock"
